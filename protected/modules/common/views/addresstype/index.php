...
$this->breadcrumbs=array(
	Catalogsys::model()->getCatalog('common')=>array('/common'),
	Catalogsys::model()->getCatalog('addresstype'));
...
function adddata()
{
	<?php echo CHtml::ajax(array(
		...
		'success'=>"function(data)
		{
			...
			{
				$('#Addresstype_addresstypeid').val('');
$('#Addresstype_addresstypename').val('');
$('#Addresstype_recordstatus').prop('checked', false);
...
function editdata()
{
	...
	echo CHtml::ajax(array(
			...
			'success'=>"function(data)
			{
				if (data.status == 'success')
				{
				$('#Addresstype_addresstypeid').val(data.addresstypeid);
$('#Addresstype_addresstypename').val(data.addresstypename);
if (data.recordstatus == 1) 
			{ 
				$('#Addresstype_recordstatus').prop('checked', true); 
			} 
			else 
			{
				$('#Addresstype_recordstatus').prop('checked', false);
...
<script type="text/javascript">
function downpdf() {
	window.open('addresstype/downpdf?id='+$.fn.yiiGridView.getSelection("datagrid"));
}
</script>
<script type="text/javascript">
function downexcel() {
	window.open('addresstype/downexcel?id='+$.fn.yiiGridView.getSelection("datagrid"));
}
</script>
<script type="text/javascript">
function searchdata()
...
$this->beginWidget(
    ...
    array(
        'title' => Catalogsys::model()->getCatalog('addresstype'),
        'headerIcon' => 'th-list',
    	'padContent' => false,
...
array(
        'id'=>'uploadFile',
        'config'=>array(
               'action'=>Yii::app()->createUrl('addresstype/upload'),
...
$this->widget('zii.widgets.grid.CGridView', array(
    ...
    array(
      ...
      'id'=>'ids',
    ),array('name'=>'addresstypeid', 'value'=>'$data->addresstypeid','htmlOptions'=>array('width'=>'1%')),array(
