...
<?php $this->widget(
		   ...
		   'onclick'=>'{
				$.fn.yiiGridView.update("datagrid", {
                    data: {
										 "contacttypename" : $("#search_contacttypename").val(),
...
<label class='col-sm-3 control-label required' for='search_contacttypename'><?php echo Catalogsys::model()->getCatalog('contacttypename') ?></label>
<div class='col-sm-6'><input type='text' id='search_contacttypename' class='form-control'></div>
</div>
