...
$this->breadcrumbs=array(
	...
	Catalogsys::model()->getCatalog('groupaccess'));
...
$('#Groupaccess_recordstatus').prop('checked', false);
...
if (data.recordstatus == 1) 
			{ 
				$('#Groupaccess_recordstatus').prop('checked', true); 
			} 
			else 
			{
				$('#Groupaccess_recordstatus').prop('checked', false);
...
<script type="text/javascript">
function downpdf() {
	window.open('groupaccess/downpdf?id='+$.fn.yiiGridView.getSelection("datagrid"));
}
</script>
<script type="text/javascript">
function downexcel() {
	window.open('groupaccess/downexcel?id='+$.fn.yiiGridView.getSelection("datagrid"));
}
</script>
<script type="text/javascript">
function searchdata()
...
$this->beginWidget(
    ...
    array(
        'title' => Catalogsys::model()->getCatalog('groupaccess'),
        'headerIcon' => 'th-list',
    	'padContent' => false,
...
array(
        'id'=>'uploadFile',
        'config'=>array(
               'action'=>Yii::app()->createUrl('groupaccess/upload'),
...
$this->widget('zii.widgets.grid.CGridView', array(
    ...
    array(
      ...
      'id'=>'ids',
    ),array('name'=>'groupaccessid', 'value'=>'$data->groupaccessid','htmlOptions'=>array('width'=>'1%')),array(
				'name'=>'groupname',
				'type'=>'raw',
