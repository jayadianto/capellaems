...
$this->breadcrumbs=array(
	...
	Catalogsys::model()->getCatalog('parameter'));
...
$('#Parameter_moduleid').val('');
$('#modulename').val('');
$('#Parameter_recordstatus').prop('checked', false);
...
$('#Parameter_moduleid').val(data.moduleid);
$('#modulename').val(data.modulename);
if (data.recordstatus == 1) 
			{ 
				$('#Parameter_recordstatus').prop('checked', true); 
			} 
			else 
			{
				$('#Parameter_recordstatus').prop('checked', false);
...
<script type="text/javascript">
function downpdf() {
	window.open('parameter/downpdf?id='+$.fn.yiiGridView.getSelection("datagrid"));
}
</script>
<script type="text/javascript">
function downexcel() {
	window.open('parameter/downexcel?id='+$.fn.yiiGridView.getSelection("datagrid"));
}
</script>
<script type="text/javascript">
function searchdata()
...
$this->beginWidget(
    ...
    array(
        'title' => Catalogsys::model()->getCatalog('parameter'),
        'headerIcon' => 'th-list',
    	'padContent' => false,
...
array(
        'id'=>'uploadFile',
        'config'=>array(
               'action'=>Yii::app()->createUrl('parameter/upload'),
...
$this->widget('zii.widgets.grid.CGridView', array(
    ...
    array(
      ...
      'id'=>'ids',
    ),array('name'=>'parameterid', 'value'=>'$data->parameterid','htmlOptions'=>array('width'=>'1%')),array(
				'name'=>'paramname',
				'type'=>'raw',
         ...
         'value'=>'$data->description'
				...
				'name'=>'moduleid',
				'type'=>'raw',
         'value'=>'($data->module!==null)?$data->module->modulename:""'
			)
			,array(
      'class'=>'CCheckBoxColumn',
      'name'=>'recordstatus',
