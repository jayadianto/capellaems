...
$this->breadcrumbs=array(
	...
	Catalogsys::model()->getCatalog('menuauth'));
...
function adddata()
{
	<?php echo CHtml::ajax(array(
		...
		'success'=>"function(data)
		{
			...
			{
				$('#Menuauth_menuauthid').val('');
$('#Menuauth_menuobject').val('');
$('#Menuauth_recordstatus').prop('checked', false);
...
if (data.recordstatus == 1) 
			{ 
				$('#Menuauth_recordstatus').prop('checked', true); 
			} 
			else 
			{
				$('#Menuauth_recordstatus').prop('checked', false);
...
<script type="text/javascript">
function downpdf() {
	window.open('menuauth/downpdf?id='+$.fn.yiiGridView.getSelection("datagrid"));
}
</script>
<script type="text/javascript">
function downexcel() {
	window.open('menuauth/downexcel?id='+$.fn.yiiGridView.getSelection("datagrid"));
}
</script>
<script type="text/javascript">
function searchdata()
...
$this->beginWidget(
    ...
    array(
        'title' => Catalogsys::model()->getCatalog('menuauth'),
        'headerIcon' => 'th-list',
    	'padContent' => false,
...
array(
        'id'=>'uploadFile',
        'config'=>array(
               'action'=>Yii::app()->createUrl('menuauth/upload'),
...
$this->widget('zii.widgets.grid.CGridView', array(
    ...
    array(
      ...
      'id'=>'ids',
    ),array('name'=>'menuauthid', 'value'=>'$data->menuauthid','htmlOptions'=>array('width'=>'1%')),array(
				'name'=>'menuobject',
				'type'=>'raw',
