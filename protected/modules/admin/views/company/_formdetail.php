...
<?php echo $form->hiddenField($model,'companyid'); ?><?php
$this->widget('ToolbarButton',array('isSave'=>true,'UrlSave'=>'company/writedetail',
	'isCancel'=>true,'UrlCancel'=>'company/cancelwritedetail','isHelpForm'=>true,'UrlHelp'=>'helpmodifdata()',
...
<?php echo $form->textFieldGroup($model, 'currencyid'); ?>
