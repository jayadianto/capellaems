...
$this->breadcrumbs=array(
	...
	Catalogsys::model()->getCatalog('wfstatus'));
...
<script type="text/javascript">
function downpdf() {
	window.open('wfstatus/downpdf?id='+$.fn.yiiGridView.getSelection("datagrid"));
}
</script>
<script type="text/javascript">
function downexcel() {
	window.open('wfstatus/downexcel?id='+$.fn.yiiGridView.getSelection("datagrid"));
}
</script>
<script type="text/javascript">
function searchdata()
...
$this->beginWidget(
    ...
    array(
        'title' => Catalogsys::model()->getCatalog('wfstatus'),
        'headerIcon' => 'th-list',
    	'padContent' => false,
...
array(
        'id'=>'uploadFile',
        'config'=>array(
               'action'=>Yii::app()->createUrl('wfstatus/upload'),
...
$this->widget('zii.widgets.grid.CGridView', array(
    ...
    array(
      ...
      'id'=>'ids',
    ),array('name'=>'wfstatusid', 'value'=>'$data->wfstatusid','htmlOptions'=>array('width'=>'1%')),array(
				'name'=>'workflowid',
				'type'=>'raw',
