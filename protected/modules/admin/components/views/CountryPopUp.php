	...
	'cssFile' => Yii::app()->theme->baseUrl . '/css/gridview.css',				
				'columns'=>array(
					...
					/* Here is The Button that will send the Data to The MAIN FORM */
						...
						"id" => "send_product",
						"onClick" => "$(\"#'.$this->IDDialog.'\").dialog(\"close\"); $(\"#'.$this->ColField.'\").val(\"$data->countryname\"); $(\"#'.$this->Prefix.'_'.$this->IDField.'\").val(\"$data->countryid\");
						'.$this->onaftersign.'
				"))',
						),
		array('name'=>'countryid', 'value'=>'$data->countryid','htmlOptions'=>array('width'=>'1%')),
					'countryname',
					),
			));
