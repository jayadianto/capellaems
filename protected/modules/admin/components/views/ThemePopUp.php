<div class="form-group">
	...
	$country=new Theme('searchwstatus');
			$country->unsetAttributes();  // clear any default values
			if(isset($_GET['Theme']))
			$country->attributes=$_GET['Theme'];
	...
	'cssFile' => Yii::app()->theme->baseUrl . '/css/gridview.css',				
				'columns'=>array(
					...
					/* Here is The Button that will send the Data to The MAIN FORM */
						...
						"id" => "send_product",
						"onClick" => "$(\"#'.$this->IDDialog.'\").dialog(\"close\"); $(\"#'.$this->ColField.'\").val(\"$data->themename\"); $(\"#'.$this->Prefix.'_'.$this->IDField.'\").val(\"$data->themeid\");
						'.$this->onaftersign.'
				"))',
						),
		array('name'=>'themeid', 'value'=>'$data->themeid','htmlOptions'=>array('width'=>'1%')),
					'themename',
					),
			));
