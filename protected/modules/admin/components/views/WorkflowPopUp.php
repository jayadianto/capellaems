	...
	'cssFile' => Yii::app()->theme->baseUrl . '/css/gridview.css',				
				'columns'=>array(
					...
					/* Here is The Button that will send the Data to The MAIN FORM */
						...
						"id" => "send_product",
						"onClick" => "$(\"#'.$this->IDDialog.'\").dialog(\"close\"); $(\"#'.$this->ColField.'\").val(\"$data->wfdesc\"); $(\"#'.$this->Prefix.'_'.$this->IDField.'\").val(\"$data->workflowid\");
						'.$this->onaftersign.'
				"))',
						),
		array('name'=>'workflowid', 'value'=>'$data->workflowid','htmlOptions'=>array('width'=>'1%')),
					'wfdesc',
					),
			));
