	...
	'cssFile' => Yii::app()->theme->baseUrl . '/css/gridview.css',				
				'columns'=>array(
					...
					/* Here is The Button that will send the Data to The MAIN FORM */
						...
						"id" => "send_product",
						"onClick" => "$(\"#'.$this->IDDialog.'\").dialog(\"close\"); $(\"#'.$this->ColField.'\").val(\"$data->username\"); $(\"#'.$this->Prefix.'_'.$this->IDField.'\").val(\"$data->useraccessid\");
						'.$this->onaftersign.'
				"))',
						),
		array('name'=>'useraccessid', 'value'=>'$data->useraccessid','htmlOptions'=>array('width'=>'1%')),
					'username',
					),
			));
