	...
	'cssFile' => Yii::app()->theme->baseUrl . '/css/gridview.css',				
				'columns'=>array(
					...
					/* Here is The Button that will send the Data to The MAIN FORM */
						...
						"id" => "send_product",
						"onClick" => "$(\"#'.$this->IDDialog.'\").dialog(\"close\"); $(\"#'.$this->ColField.'\").val(\"$data->groupname\"); $(\"#'.$this->Prefix.'_'.$this->IDField.'\").val(\"$data->groupaccessid\");
						'.$this->onaftersign.'
				"))',
						),
		array('name'=>'groupaccessid', 'value'=>'$data->groupaccessid','htmlOptions'=>array('width'=>'1%')),
					'groupname',
					),
			));
