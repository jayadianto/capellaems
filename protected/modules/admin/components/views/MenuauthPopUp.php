	...
	'cssFile' => Yii::app()->theme->baseUrl . '/css/gridview.css',				
				'columns'=>array(
					...
					/* Here is The Button that will send the Data to The MAIN FORM */
						...
						"id" => "send_product",
						"onClick" => "$(\"#'.$this->IDDialog.'\").dialog(\"close\"); $(\"#'.$this->ColField.'\").val(\"$data->menuobject\"); $(\"#'.$this->Prefix.'_'.$this->IDField.'\").val(\"$data->menuauthid\");
						'.$this->onaftersign.'
				"))',
						),
		array('name'=>'menuauthid', 'value'=>'$data->menuauthid','htmlOptions'=>array('width'=>'1%')),
					'menuobject',
					),
			));
