...
class Wfgroup extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('workflowid, groupaccessid, wfbefstat, wfrecstat', 'required'),
			array('workflowid, groupaccessid, wfbefstat, wfrecstat', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('wfgroupid, workflowid, groupaccessid, wfbefstat, wfrecstat', 'safe', 'on'=>'search'),
		);
	}
	...
	{
		return array(
			'wfgroupid' => Catalogsys::model()->getCatalog('ID'),
			'workflowid' => Catalogsys::model()->getCatalog('Workflow'),
			'groupaccessid' => Catalogsys::model()->getCatalog('GroupAccess'),
			'wfbefstat' => Catalogsys::model()->getCatalog('wfbefstat'),
			'wfrecstat' => Catalogsys::model()->getCatalog('wfrecstat'),
