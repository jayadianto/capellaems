...
class Wfstatus extends CActiveRecord
{
	...
	{
		return array(
			'wfstatusid' => Catalogsys::model()->getCatalog('wfstatusid'),
			'workflowid' => Catalogsys::model()->getCatalog('workflow'),
			'wfstat' => Catalogsys::model()->getCatalog('WfStatus'),
			'wfstatusname' => Catalogsys::model()->getCatalog('wfStatusText'),
		);
	}
...
$this->comparedb($criteria);
		...
		'sort' => array(
        'defaultOrder' => 't.wfstatusid desc', 
    ),
		));
	}
}