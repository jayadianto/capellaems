...
<?php $form=$this->beginWidget('CCodeForm', array('model'=>$model)); ?>
	...
	<div class="row">
		<?php echo $form->labelEx($model,'isdetail'); ?>
		<?php echo $form->checkBox($model,'isdetail'); ?>
		<div class="tooltip">
		...
		<?php echo $form->error($model,'isdetail'); ?>
	</div>
	
	<div class="row">
		<?php echo $form->labelEx($model,'modeldetail'); ?>
		<?php echo $form->textField($model,'modeldetail',array('size'=>65)); ?>
		<div class="tooltip">
			Model class is case-sensitive. It can be either a class name (e.g. <code>Post</code>)
		    or the path alias of the class file (e.g. <code>application.models.Post</code>).
		    Note that if the former, the class must be auto-loadable.
